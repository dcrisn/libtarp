...
/*
 * Stack implementation (LIFO) and queue (LIFO);
 * the queue is actually an output-restricted deque 
 */
 ...
 *
 * NOTICE difference between freebsd and linux approach: freebsd points to and operates
 * directly on the enclosing container, naturally. It asks the user to specify the name
 * of the contained field to be able to get the queue entries etc; Linux otoh works 
 * on the enclosed type and then uses container_of to get the enclosing container. 
 */
